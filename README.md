...
| 🛡️ **Infrastructure** | `Linux Mint` `Bash` `Git` `SQL` `Network Security` | 📈 Intermediate |
| 📊 **Mathematics** | `Calculus` `Linear Algebra` `Probability` `Statistical Modeling` | 🎓 Academic Focus |
...
- Joined **DECI (Digital Egypt Cubs Initiative)** – algorithmic thinking  
- Adopted **Linux Mint** – full open‑source fluency  
- Built strong foundations in **data structures** & **C++ / Python**
</details>

<details>
<summary><b>🏆 2025 – Recognition & Awards</b></summary>

- **Huawei Certifications** (AI, Big Data, Cloud Computing)  
...
<details open>
<summary><b>🚀 2026 – Research & Specialization (Current)</b></summary>

- **Level 3 DECI Scholar** (AI & Data Science track)  
- **McKinsey Forward Program** – leadership & data‑driven decisions  
- **NLP research** – predictive models & language understanding  
- **National Robotics League** – AI + embedded systems
</details>
...
| | | |
|:---:|:---:|:---:|
| 🥇 **DECI Excellence Award** | 🌌 **NASA Innovator** | 💼 **McKinsey Global Alum** |
| 🦾 **Robotics Finalist** | 📜 **Huawei Certified** | 🧠 **Level 3 Scholar – AI** |
...
- 📚 **Continuous learning** – mastery through every line of code  
